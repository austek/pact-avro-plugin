...
import com.collibra.example.pulsar.avro.OrderService;
...
@PactTestFor(providerName = "order-provider", providerType = ProviderType.ASYNCH, pactVersion = PactSpecVersion.V4)
class PactPulsarConsumerTest {
    private final String schemasPath = Objects.requireNonNull(getClass().getResource("/avro/orders.avsc")).getPath();
