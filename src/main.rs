...
use pact_avro_plugin::server::AvroPactPlugin;
use pact_avro_plugin::tcp::TcpIncoming;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Setup tracing
    let formatting_layer = BunyanFormattingLayer::new("pact-avro-plugin".into(), json_non_blocking);
